...
def load_documents(docs_path="docs"):
    """Load all text files from the docs directory in order to create a vector store 
    for RAG through embedding during the ingestion pipeline."""
...
def split_documents(documents, chunk_size=1000, chunk_overlap=0):
    ...
    """Naive approach: Split each document into chunks of chunk_size characters with 
    ...
    """We get a list of Document objects, each containing a chunk of text and its metadata.
    [
